...
namespace Aoc2018.Solutions
{
    public class D24P2 : Solver<int>
    {
        ...
        protected override int GetAnswer(string input)
        {
            ...
            while (true)
            {
                var (immune, infection) = CreateArmiesWithBoost(++boost);

                Battle(immune, infection);

                if (!infection.IsAlive() && immune.IsAlive())
                {
        ...
        private Tuple<Army, Army> CreateArmiesWithBoost(int boost)
        {
            var immune = new Army() { Name = "Immune System" };
            immune.Regiments.Add(new Regiment(immune, 4592, 2061, boost + 4, 9, Attack.F, new Attack[] { Attack.S, Attack.R }, new Attack[] { Attack.C }));
            immune.Regiments.Add(new Regiment(immune, 1383, 3687, boost + 26, 15, Attack.R, new Attack[] { }, new Attack[] { }));
            immune.Regiments.Add(new Regiment(immune, 2736, 6429, boost + 20, 2, Attack.S, new Attack[] { Attack.S }, new Attack[] { }));
            immune.Regiments.Add(new Regiment(immune, 777,  3708, boost + 39, 4, Attack.C, new Attack[] { Attack.R, Attack.C }, new Attack[] { Attack.S, Attack.F }));
            immune.Regiments.Add(new Regiment(immune, 6761, 2792, boost + 3, 17, Attack.R, new Attack[] { Attack.B, Attack.F, Attack.C, Attack.S }, new Attack[] { }));
            immune.Regiments.Add(new Regiment(immune, 6028, 5537, boost + 7, 6, Attack.R, new Attack[] { Attack.S }, new Attack[] { }));
            immune.Regiments.Add(new Regiment(immune, 2412, 2787, boost + 9, 20, Attack.B, new Attack[] { }, new Attack[] { }));
            immune.Regiments.Add(new Regiment(immune, 6042, 7747, boost + 12, 12, Attack.S, new Attack[] { Attack.R }, new Attack[] { }));
            immune.Regiments.Add(new Regiment(immune, 1734, 7697, boost + 38, 10, Attack.C, new Attack[] { }, new Attack[] { Attack.R, Attack.C }));
            immune.Regiments.Add(new Regiment(immune, 4391, 3250, boost + 7, 19, Attack.C, new Attack[] { }, new Attack[] { }));
